...
About libholoscan-dev
---------------------

Home: https://docs.nvidia.com/cuda/holoscan/

Package license: [LicenseRef-NVIDIA-End-User-License-Agreement, BSD-2-Clause, BSD-3-Clause AND CC0-1.0](https://developer.download.nvidia.com/assets/Clara/NVIDIA_Clara_EULA.pdf)
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libholoscan-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libholoscan-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `libholoscan` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
```
conda install libholoscan libholoscan-dev
```
...
```
mamba install libholoscan libholoscan-dev
```
...
pixi add libholoscan libholoscan-dev
# for installing globally
pixi global install libholoscan libholoscan-dev
```
...
It is possible to list all of the versions of `libholoscan` available on your platform:
...
```
pixi search libholoscan --channel conda-forge
```
...
Updating libholoscan-feedstock
==============================

If you would like to improve the libholoscan recipe or build a new
...
Note that all branches in the conda-forge/libholoscan-feedstock are
